mpiexec -np 2 python -u -m lshapedhub --num-scens 2 --default-rho=1 --bundles-per-rank=0 --max-iterations=50 --solver-name=gurobi_persistent --rel-gap=0.0 --xhatlshaped 
